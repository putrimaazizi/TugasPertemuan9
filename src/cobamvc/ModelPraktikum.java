...
public class ModelPraktikum {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/praktikum";
    ...
    public ModelPraktikum(){
        try{
            ...
            koneksi = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/praktikum?serverTimezone=UTC", "root", "");
